...
class DirectedPathFinding4 {
    ...
    public DirectedPathFinding4(int V) {
        this.V = V;
    ...
    public DirectedPathFinding4(String fileName) throws FileNotFoundException {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        DirectedPathFinding4 graph = new DirectedPathFinding4(args[0]);
