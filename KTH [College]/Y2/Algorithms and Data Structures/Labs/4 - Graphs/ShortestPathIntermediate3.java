...
class ShortestPathIntermediate3 {
    private final int V;
    ...
    public ShortestPathIntermediate3(int V) {
        this.V = V;
    ...
    public ShortestPathIntermediate3(String fileName) throws FileNotFoundException {
    ...
    public void findPathIntermediate(String val1, String val2, String val3) {
        findPath(val1, val2);
        findPath(val2, val3);
    }
    
    private void findPath(String val1, String val2) {
    ...
    private void findPath(int x, int y) {
        ...
        else throw new NoSuchElementException("No path exists.");
    }
    
    public static void main(String[] args) throws FileNotFoundException {
        Scanner sc = new Scanner(System.in);
        ShortestPathIntermediate3 graph = new ShortestPathIntermediate3(args[0]);
        
        System.out.println("Input the three states you would like to traverse.");
        graph.findPathIntermediate(sc.next(), sc.next(), sc.next());
    }
}